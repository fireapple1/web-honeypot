...
C 모듈이 attack_type을 제외하고 INSERT하면, Kotlin 서버가 주기적으로 읽어 분류 후 UPDATE한다.
...
### API 엔드포인트
메서드경로설명GET/api/logs최근 로그 목록GET/api/stats공격 유형별 통계GET/api/top-ips상위 공격자 IP 목록
